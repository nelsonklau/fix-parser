    ...
    private static Stream<Arguments> validByteArraySource() {
        return Stream.of(
                ...
                Arguments.of(new byte[]{0x38, 0x3d, 0x46, 0x49, 0x58, 0x2e, 0x34, 0x2e, 0x34, 0x01,
                                ...
                                0x34, 0x30, 0x3d, 0x31, 0x01,
                                0x35, 0x34, 0x3d, 0x31, 0x01,
                                0x37, 0x31, 0x31, 0x3d, 0x32, 0x01,
                                0x33, 0x31, 0x31, 0x3d, 0x4d, 0x53, 0x46, 0x54, 0x2e, 0x4f, 0x51, 0x01,
                                0x33, 0x30, 0x39, 0x3d, 0x4d, 0x53, 0x46, 0x54, 0x2e, 0x4f, 0x51, 0x01,
                                0x33, 0x30, 0x35, 0x3d, 0x35, 0x01,
                                0x33, 0x31, 0x31, 0x3d, 0x4d, 0x53, 0x46, 0x54, 0x2e, 0x4f, 0x51, 0x01,
                                0x33, 0x30, 0x39, 0x3d, 0x4d, 0x53, 0x46, 0x54, 0x2e, 0x4f, 0x51, 0x01,
                                0x33, 0x30, 0x35, 0x3d, 0x35, 0x01,
                                0x35, 0x35, 0x3d, 0x4d, 0x53, 0x46, 0x54, 0x01,
                        ...
                        (Supplier<Map<Float, List<Byte>>>) () -> {
                            ...
                            expected.putAll(Map.of(
                                    ...
                                    40.0f, List.of((byte) 0x31),
                                    54.0f, List.of((byte) 0x31),
                                    711.0f, List.of((byte) 0x32),
                                    311.0f, List.of((byte) 0x4d, (byte) 0x53, (byte) 0x46, (byte) 0x54, (byte) 0x2e, (byte) 0x4f, (byte) 0x51),
                                    309.0f, List.of((byte) 0x4d, (byte) 0x53, (byte) 0x46, (byte) 0x54, (byte) 0x2e, (byte) 0x4f, (byte) 0x51),
                                    305.0f, List.of((byte) 0x35),
                                    311.1f, List.of((byte) 0x4d, (byte) 0x53, (byte) 0x46, (byte) 0x54, (byte) 0x2e, (byte) 0x4f, (byte) 0x51),
                                    309.1f, List.of((byte) 0x4d, (byte) 0x53, (byte) 0x46, (byte) 0x54, (byte) 0x2e, (byte) 0x4f, (byte) 0x51)
                            ));
                            expected.putAll(Map.of(
                                    305.1f, List.of((byte) 0x35),
                                    55.0f, List.of((byte) 0x4d, (byte) 0x53, (byte) 0x46, (byte) 0x54),
                                    48.0f, List.of((byte) 0x4d, (byte) 0x53, (byte) 0x46, (byte) 0x54, (byte) 0x2e, (byte) 0x4f, (byte) 0x51),
                                    22.0f, List.of((byte) 0x35),
                                    454.0f, List.of((byte) 0x34),
