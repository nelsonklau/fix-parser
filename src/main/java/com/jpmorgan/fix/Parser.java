...
public final class Parser {
    ...
    // TODO: allocate correct initial capacity
    private final static Map<Integer, Set<Integer>> GROUP_MEMBER_DEFINITIONS = new HashMap<>(60, 1);
    private final static Map<Integer, Set<Integer>> OPTIONAL_GROUP_MEMBER_DEFINITIONS = new HashMap<>(57, 1);

    static {
        GROUP_MEMBER_DEFINITIONS.put(454, Set.of());
        GROUP_MEMBER_DEFINITIONS.put(711, Set.of());
        ...
        OPTIONAL_GROUP_MEMBER_DEFINITIONS.put(936, Set.of(930, 931, 283, 284, 928, 929));
        OPTIONAL_GROUP_MEMBER_DEFINITIONS.put(518, Set.of(519, 520, 521));
        OPTIONAL_GROUP_MEMBER_DEFINITIONS.put(382, Set.of(375, 337, 437, 438, 655));
        ...
        OPTIONAL_GROUP_MEMBER_DEFINITIONS.put(124, Set.of(32, 17, 527, 31, 669, 29));
        ...
        OPTIONAL_GROUP_MEMBER_DEFINITIONS.put(558, Set.of(
                167, 762, 460, 461));
